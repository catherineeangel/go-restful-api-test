...
func (mr *MockCustomerServiceMockRecorder) Delete(ctx, categoryId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCustomerServiceMockRecorder) FindById(ctx, categoryId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
